...
@Component({
  selector: 'zc-form-control-detailed',
  templateUrl: './form-control-detailed.component.html',
  styleUrls: ['../../form-template.component.css']
})
export class FormControlDetailedComponent implements OnInit {
  ...
  openLibraryBoxEs() {
    ...
    console.log('打开控件库B', this.tempadd);
    setTimeout(() => {
