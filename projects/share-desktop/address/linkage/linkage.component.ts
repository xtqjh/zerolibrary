 ...
 */
import { Component, OnInit, OnDestroy, HostListener, Output, EventEmitter, Input, ChangeDetectionStrategy, ViewEncapsulation } from '@angular/core';
...
export class LinkageComponent implements OnDestroy {
